...
- 2x 4-OR gates ((+ additional OR for '0' button which otherwise is not captured) for two triggers: one for the 3- state buffer of the key encoder (4-OR gate, 4072), one for the signal switch  
